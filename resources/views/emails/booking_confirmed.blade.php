...
<body>
    <div class="container">
        ...
        <div class="section">
                ...
                <div class="col">
                    <div class="card">
                        ...
                        <ul class="list">
                            ...
                            <li>e‑Mail: <a href="mailto:{{ $booking->guest_email }}">{{ $booking->guest_email }}</a>
                            </li>
            ...
            <div class="cta">
                <a class="button" href="{{ url('/bookings/' . $booking->id) }}">View Booking Details</a>
            </div>
        </div>

        <div class="footer">
            To see your booking details, use the button above. Thank you for choosing
            {{ config('mail.from.name', config('app.name', 'our hotel')) }}.
        </div>
    </div>
</body>
